package com.example.skinloader.config;

import android.content.Context;

import com.example.skinloader.util.PreferencesUtils;
...
public class SkinConfig {
    ...
    public static final String PREF_CUSTOM_SKIN_PATH = "cn_pgg_skin_custom_path";
    public static final String DEFALT_SKIN = "cn_pgg_skin_default";//默认皮肤
    public static final String SKIN_FROM = "cn_pgg_skin_from";
