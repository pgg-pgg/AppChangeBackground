...
import com.example.skinloader.listener.ISkinLoader;
...
public class SkinManager implements ISkinLoader {
    ...
    //当前皮肤是否是默认皮肤
    private boolean isDefaluteSkin=false;

    private String skinPackageName;//皮肤报名
    ...
    public boolean isExternalSkin(){
        return !isDefaluteSkin&&mResources!=null;
    }
            ...
            protected Resources doInBackground(String... params) {
                try {
                    if (params.length == 1) {
                        ...
                        PackageInfo packageArchiveInfo = packageManager.getPackageArchiveInfo(skinPkgPath, PackageManager.GET_ACTIVITIES);
                        skinPackageName = packageArchiveInfo.packageName;//获取报名
    ...
    public int getColor(int resId) {
        ...
        if (mResources == null || isDefaluteSkin) {
            return originColor;
        }
